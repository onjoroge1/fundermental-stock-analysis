...
FACT_FIELDS = {
    ...
    "research_and_development": ("income_statement", "Research and development"),
    "selling_general_and_administrative": ("income_statement", "Selling, general and administrative"),
    "operating_income": ("income_statement", "Operating income"),
    "pretax_income": ("income_statement", "Pretax income"),
    "income_tax": ("income_statement", "Income tax"),
    "net_income": ("income_statement", "Net income"),
    "basic_eps": ("income_statement", "Basic EPS"),
    ...
    "accounts_payable": ("balance_sheet", "Accounts payable"),
    "current_liabilities": ("balance_sheet", "Current liabilities"),
    "noncurrent_liabilities": ("balance_sheet", "Noncurrent liabilities"),
    "short_term_debt": ("balance_sheet", "Current debt"),
    "commercial_paper": ("balance_sheet", "Commercial paper"),
    "long_term_debt": ("balance_sheet", "Noncurrent debt"),
    "total_liabilities": ("balance_sheet", "Total liabilities"),
    "shareholders_equity": ("balance_sheet", "Shareholders equity"),
    "operating_cash_flow": ("cash_flow", "Operating cash flow"),
    "capital_expenditures": ("cash_flow", "Capital expenditures"),
    "share_repurchases": ("cash_flow", "Share repurchases"),
    "dividends_paid": ("cash_flow", "Dividends paid"),
    "stock_based_compensation": ("cash_flow", "Stock-based compensation"),
    "weighted_average_basic_shares": ("shares", "Weighted average basic shares"),
    "weighted_average_diluted_shares": ("shares", "Weighted average diluted shares"),
}
