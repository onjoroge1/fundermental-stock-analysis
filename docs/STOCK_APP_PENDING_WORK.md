...
| Accounting and missing fundamentals | PR #46 released; recovery run 34170649141 verified 32 UBER fixes, seven cover-share recoveries and eight forecast rebuilds. Recovery now shares the daily writer's concurrency group to prevent overlapping old-code refreshes | Resolve 20 older failures, missing liability coverage and seven quarterly EPS gaps. See ACCOUNTING_DATA_RECOVERY.md and the latest serialized recovery run for live counts. |
